...
export default function LogIn() {
  ...
  const signIn = async () => {
    ...
    if (!error) {
      try {
        ...
        setGenericError("Error logging in, please try again.");
      }
    }
    setLoading(false);
  };
  ...
  return (
    <FormContainer>
      ...
      <TextInput
        // Usually would use email type here but wanted to check validation worked
        type="text"
        autoComplete="email"
        placeholder="Email"
        value={email}
      ...
      <FormFooter>
        ...
        <ButtonContainer>
          <FormButton onClick={() => signIn()} loading={loading}>
            Sign In
          </FormButton>
        </ButtonContainer>
      </FormFooter>
